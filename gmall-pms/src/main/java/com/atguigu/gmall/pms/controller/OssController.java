...
public class OssController {
    ...
    public Resp<Object> policy() {
        String accessId = "LTAI4FrnExHqGsfaDmUmLtwG"; // 请填写您的AccessKeyId。
        String accessKey = "97r3X3mc99xCQT1HCIltU0sNoznNXA"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "guigugmall"; // 请填写您的 bucketname 。
