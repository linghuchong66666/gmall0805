...
@Api(tags = "库存工作单 管理")
@RestController
@RequestMapping("pms/wareordertaskdetail")
public class WareOrderTaskDetailController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('pms:wareordertaskdetail:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('pms:wareordertaskdetail:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('pms:wareordertaskdetail:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('pms:wareordertaskdetail:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('pms:wareordertaskdetail:delete')")
